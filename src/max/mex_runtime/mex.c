...
static struct _usrfunc _intrinfunc[]=
{
  ...
  {"ui_begin_update",         intrin_ui_begin_update,         0},
  {"ui_end_update",           intrin_ui_end_update,           0},
  {"ui_make_attr",            intrin_ui_make_attr,            0},
  {"ui_mci2attr",             intrin_mci2attr,                0},
  {"ui_set_attr",             intrin_ui_set_attr,             0},
  {"ui_box",                  intrin_ui_box,                  0},
  {"ui_fill_rect",            intrin_ui_fill_rect,            0},
  {"ui_write_padded",         intrin_ui_write_padded,         0},
  {"ui_region_get",           intrin_ui_region_get,           0},
  {"ui_region_put",           intrin_ui_region_put,           0},
  {"ui_region_drop",          intrin_ui_region_drop,          0},
  {"ui_region_width",         intrin_ui_region_width,         0},
  {"ui_region_height",        intrin_ui_region_height,        0},
  {"ui_gettext",              intrin_ui_region_get,           0},
  {"ui_puttext",              intrin_ui_region_put,           0},
  {"ui_block_drop",           intrin_ui_region_drop,          0},
  {"ui_block_width",          intrin_ui_region_width,         0},
  {"ui_block_height",         intrin_ui_region_height,        0},
  {"ui_paint_region",         intrin_ui_paint_region,         0},
  {"ui_save_screen",          intrin_ui_save_screen,          0},
  {"ui_restore_screen",       intrin_ui_restore_screen,       0},
  {"ui_drop_screen",          intrin_ui_drop_screen,          0},
  {"ui_window_push",          intrin_ui_window_push,          0},
  {"ui_window_pop",           intrin_ui_window_pop,           0},
  {"ui_window_drop",          intrin_ui_window_drop,          0},
  {"ui_window_create",        intrin_ui_window_push,          0},
  {"ui_window_remove",        intrin_ui_window_pop,           0},
  ...
  {"ui_overlay_push",        intrin_ui_overlay_push,          0},
  {"ui_overlay_pop",         intrin_ui_overlay_pop,           0},
  {"ui_overlay_drop",        intrin_ui_overlay_drop,          0},
